...
export function rows(t){return [{k:'sinA',n:t.a,d:t.c},{k:'cosA',n:t.b,d:t.c},{k:'tanA',n:t.a,d:t.b},{k:'sinB',n:t.b,d:t.c},{k:'cosB',n:t.a,d:t.c},{k:'tanB',n:t.b,d:t.a}].map(r=>{const bothInt=Number.isInteger(r.n)&&Number.isInteger(r.d);const s=bothInt?simplify(r.n,r.d):{num:r.n,den:r.d,changed:false};return {...r,s};});}
